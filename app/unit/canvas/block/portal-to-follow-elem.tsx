...
export function PortalToFollowElem({children, ...options}: { children: React.ReactNode } & PortalToFollowElemOptions) {
...
export const PortalToFollowElemTrigger = React.forwardRef<HTMLElement, React.HTMLProps<HTMLElement> & {
    asChild?: boolean
